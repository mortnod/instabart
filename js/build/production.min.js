...
!(function (a) {
  a.fn.extend({
    leanModal: function (b) {
      ...
      var d = { top: 100, overlay: 0.5, closeButton: null },
      ...
      return (
        ...
        this.each(function () {
          ...
          a(this).click(function (b) {
            ...
            a(e).outerHeight(), a(e).outerWidth();
  ...
  (window.Modernizr = (function (a, b, c) {
    ...
    (m =
      ...
      (C.hashchange = function () {
        return (
          I("hashchange", a) && (b.documentMode === c || b.documentMode > 7)
        );
      }),
      (C.history = function () {
  ...
  Modernizr.addTest("cssfilters", function () {
    ...
    return (
      (a.style.cssText = Modernizr._prefixes.join("filter:blur(2px); ")),
      !!a.style.length &&
    ...
    a.addTest("csstransformspreserve3d", function () {
      ...
      return d
        ? ((d = d
            ...
            .replace(/^ms-/, "-ms-")),
          a.testStyles("#modernizr{" + d + ":" + e + ";}", function (a, e) {
            c = b.getComputedStyle
              ? getComputedStyle(a, null).getPropertyValue(d)
              : "";
          }),
          c === e)
        : !1;
  ...
  (this.Handlebars.templates.tagline = Handlebars.template(function (
    ...
    return (
      (g = c.tagline)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.tagline),
          (f = typeof g === h ? g.call(b, { hash: {}, data: e }) : g)),
      f || 0 === f ? f : ""
    );
  }));
var s,
  Card = {
    settings: {
      cards: null,
      infoBtn: null,
      jqueryFlip: { shrink: null, expand: null },
    },
    init: function () {
      (s = this.settings),
    ...
    createCards: function (a) {
      for (
        var b = Handlebars.templates.card, c = 0;
        c < data.cards.length;
        c++
      ) {
        var d = b(data.cards[c]);
        $("#grid").append(d);
      }
      a();
    },
    ...
    resizeCards: function () {
      var a = s.cards.outerWidth();
      s.cards.css("height", a);
    },
    ...
    flipCardWithCSS: function (a) {
      $(".back").show();
      var b = a.parents(".content");
      return (
        b.hasClass("flipped")
          ? b.removeClass("flipped")
          : ($(".flipped").removeClass("flipped"), b.addClass("flipped")),
        !1
      );
    },
    flipCardWithJQuery: function (a) {
      var b = a.parent(),
        c = $(".back:visible");
      b.hasClass("back")
        ? Card.animateJQueryFlip(c)
        : (Card.animateJQueryFlip(c), Card.animateJQueryFlip(b));
    },
    animateJQueryFlip: function (a) {
      var b = a.siblings(".cardface");
      a.animate(s.jqueryFlip.shrink, 100, function () {
        a.hide(),
          b.show(),
          b.animate(s.jqueryFlip.expand, 100, function () {
            $(this).width("");
          });
      });
    },
  ...
  Modal = {
    ...
    hide: function (a) {
      $(a).fadeOut(100), $("#lean_overlay").fadeOut(200);
    },
  },
  data = {
    cards: [
  ...
  Schedule = {
    ...
    firstTimeSetupCompleted: function () {
      return void 0 === localStorage.schedule_clicked
        ? !1
        : JSON.parse(localStorage.schedule_clicked);
    },
    setScheduleLink: function () {
      var a = localStorage.schedule_name.toLowerCase(),
        b = "http://ntnu.1024.no/" + a;
      $("#schedule a").prop("href", b);
    },
    addSettingsButton: function () {
      var a = '<i id="schedule-settings-button" class="cogwheel"></i>';
      $("#schedule .front").append(a);
    },
    inputValid: function () {
      return "" !== $("#schedule_name").val();
    },
    saveAndRedirect: function (a) {
      (localStorage.schedule_clicked = "true"),
        (localStorage.schedule_name = a),
        this.setScheduleLink(),
    ...
    displaySettingsOnClick: function (a) {
    ...
    bindUIActions: function () {
      $("#schedule-settings-button").click(function () {
        ...
        $("#schedule-no-button").click(function () {
          Analytics.trackScheduleAnswerNo(), Schedule.saveAndRedirect("");
        }),
        $("#schedule-yes-button").click(function () {
          if (Schedule.inputValid()) {
            Analytics.trackScheduleAnswerYes();
            var a = $("#schedule_name").val();
            Schedule.saveAndRedirect(a);
          } else $("#schedule_name").addClass("error");
        }),
        $("#schedule_name").keypress(function (a) {
          if (13 == a.which)
            if ((a.preventDefault(), Schedule.inputValid())) {
              Analytics.trackScheduleAnswerYes();
              var b = $("#schedule_name").val();
              Schedule.saveAndRedirect(b);
            } else $("#schedule_name").addClass("error");
        });
    },
  },
  Analytics = {
    init: function () {
      this.createEventTrackers(), this.createScheduleEventTrackers();
    },
    ...
    normalEvent: function (a, b, c) {
      void 0 === c
        ? Analytics.sendEvent(a, b)
        : $(c).click(function () {
            Analytics.sendEvent(a, b);
          });
    },
    outboundEvent: function (a, b, c) {
      var d = $(c);
      d.click(function (c) {
        Analytics.sendEvent(a, b),
          c.metaKey ||
            ...
            (c.preventDefault(),
            setTimeout(function () {
              document.location.href = d.prop("href");
            }, 100));
      });
    },
    createEventTrackers: function () {
      this.outboundEvent("Main Links", "Blackboard", "#blackboard .track-main"),
        ...
        this.outboundEvent(
          "Modal",
          "Lean Modal (built with)",
          "#track-leanmodal"
        ),
        this.outboundEvent(
          "Modal",
          "Handlebars (built with)",
          "#track-handlebars"
        ),
        this.outboundEvent(
          "Modal",
          "Normalize (built with)",
          "#track-normalize"
        ),
        this.outboundEvent("Modal", "Icomoon (built with)", "#track-icomoon"),
        this.outboundEvent(
          "Modal",
          "Glyphicons (built with)",
          "#track-glyphicons"
        ),
    ...
    createScheduleEventTrackers: function () {
      Schedule.supportsLocalStorage() && !Schedule.firstTimeSetupCompleted()
        ? this.normalEvent(
            "Schedule Settings",
    ...
    trackAppActivation: function () {
      Schedule.supportsLocalStorage() &&
        void 0 === localStorage.app_activated &&
  ...
  Header = {
    init: function () {
      this.createTagline(), this.bindUIActions();
    },
    createTagline: function () {
      var a = Handlebars.templates.tagline,
        b = Header.randomTagline(data.taglines),
        c = a(b);
      $("#tagline").append(c);
    },
    randomTagline: function (a) {
...
Alerts = {
  init: function () {
    Schedule.supportsLocalStorage() &&
      this.shouldAlertBeDisplayed() &&
      this.displayAlert();
  },
  shouldAlertBeDisplayed: function () {
    return void 0 === localStorage.office365_alert_closed
      ? !0
      : !JSON.parse(localStorage.office365_alert_closed);
  },
...
var Links = {
    ...
    router: function () {
      var a = this.getCardLink(this.parseHashUrl());
      window.location.hash && a && this.redirect(a);
    },
    redirect: function (a) {
    ...
    getCardLink: function (a) {
      return void 0 !== data.cards[a - 1] ? data.cards[a - 1].link : !1;
    },
  },
  Hotkeys = function () {
    var a = function (a) {
        var d = b(c(a));
        d !== !1 && (window.location.href = d);
      },
      b = function (a) {
        return void 0 !== data.cards[a - 1] ? data.cards[a - 1].link : !1;
      },
